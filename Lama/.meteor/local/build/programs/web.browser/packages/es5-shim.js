...
if (!Object.getPrototypeOf) {                                                                                          // 55
    ...
    Object.getPrototypeOf = function getPrototypeOf(object) {                                                          // 63
        ...
        if (proto || proto === null) {                                                                                 // 67
          ...
          // Correctly return null for Objects created with `Object.create(null)`                                      // 72
          // (shammed or native) or `{ __proto__: null}`.  Also returns null for                                       // 73
          // cross-realm objects on browsers that lack `__proto__` support (like                                       // 74
          // IE <11), but that's the best we can do.                                                                   // 75
          return null;                                                                                                 // 76
        } else {                                                                                                       // 77
          return prototypeOfObject;                                                                                    // 78
        }                                                                                                              // 79
    };                                                                                                                 // 80
}                                                                                                                      // 81
                                                                                                                       // 82
