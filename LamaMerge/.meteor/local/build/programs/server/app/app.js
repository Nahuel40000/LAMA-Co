...
_meteor.Meteor.publish('annonce', function (search) {                                                        // 97
  check(search, Match.OneOf(String, null, undefined)); //permet de vérifier le contenu de la recherche       // 98
                                                                                                             //
  var query = {},                                                                                            // 97
      projection = { limit: 10, sort: { title: 1 } }; //on trie les annonces selon leur titre                //
                                                                                                             //
  if (search) {                                                                                              // 97
    var regex = new RegExp(search, 'i');                                                                     // 104
                                                                                                             //
    query = {                                                                                                // 106
      $or: [{ title: regex }, //permet de taper Pascal, pascal ou PASCAL et de toujour trouver la même chose
      { author: regex }]                                                                                     // 109
    };                                                                                                       //
                                                                                                             //
    projection.limit = 100;                                                                                  // 113
  }                                                                                                          //
                                                                                                             //
  return AnnonceList.find(query, projection);                                                                // 116
});                                                                                                          //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
